    ...
    void (async () => {
      try {
        const response = await storeApiFetch(
          "/store/products?new_arrival=1&per_page=4"
        );
    ...
    <section className="px-5 py-16 sm:px-6 lg:px-10">
      <div className="mx-auto max-w-7xl">
        ...
        {loading ? (
          ...
          <div className="mt-10 rounded-2xl border border-dashed border-[#d8cfbf] p-10 text-center text-sm text-[#777]">
            No new arrivals are marked yet.
          </div>
        )}
      </div>
    </section>
