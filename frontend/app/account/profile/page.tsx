...
function toLocalIndianPhone(value?: string | null) {
  if (!value) {
    return "";
  }
  ...
  */
  ...
  /*
  |--------------------------------------------------------------------------
  | Keep Only 10 Digit Mobile Number
  |--------------------------------------------------------------------------
  */
...
function toApiIndianPhone(value: string) {
...
export default function CustomerProfilePage() {
  ...
  |--------------------------------------------------------------------------
  |
  | phone state contains ONLY:
  |
  | 9685989568
  |
  | It NEVER contains +91.
  |
  */
  ...
  const loadProfile = useCallback(async () => {
    ...
    try {
      ...
      const response = await customerApiFetch("/customer/profile");
      ...
      setPhone(toLocalIndianPhone(profile.phone));
    } catch {
  ...
  function firstError(data: any) {
    ...
    return String(errors[0] || data.message || "Something went wrong.");
  }
    ...
    try {
      ...
      const response = await customerApiFetch("/customer/profile", {
        ...
        body: JSON.stringify({
          ...
          /*
                |--------------------------------------------------------------------------
                | Send Full Normalized Indian Number
                |--------------------------------------------------------------------------
                */

          phone: toApiIndianPhone(phone),
        }),
      });
      ...
      const updatedProfile: Customer = data.data;
      ...
      */
      ...
      /*
      |--------------------------------------------------------------------------
      | Keep Input As Only 10 Digits
      |--------------------------------------------------------------------------
      */

      setPhone(toLocalIndianPhone(updatedProfile.phone));
      ...
      */
      ...
      localStorage.setItem("customer_user", JSON.stringify(updatedProfile));
  ...
  async function changePassword(event: FormEvent) {
    ...
    try {
      ...
      const response = await customerApiFetch("/customer/profile/password", {
        method: "PUT",
      ...
      if (!response.ok) {
        setPasswordError(firstError(data));
      ...
      <div className="mx-auto max-w-6xl">
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 lg:grid-cols-[1.25fr_0.75fr]">
          ...
          <section className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-sm">
            ...
            <form onSubmit={saveProfile} className="p-5 sm:p-7">
              {error && customer && (
                ...
                <div>
                  ...
                  <div>
                    <div className="flex overflow-hidden rounded-xl border border-gray-200 bg-gray-50 transition focus-within:border-[#8f0828] focus-within:bg-white focus-within:ring-4 focus-within:ring-[#8f0828]/5">
                      ...
                      <div className="flex items-center gap-2 border-r border-gray-200 bg-white/70 px-4 text-sm font-semibold text-gray-700">
                        <Phone size={18} className="text-gray-400" />

                        <span>+91</span>
                      </div>

                      {/* Only 10 editable digits */}
          ...
          <aside className="space-y-6">
            <div className="overflow-hidden rounded-3xl border border-gray-200 bg-white shadow-sm">
              <div className="bg-gradient-to-br from-[#8f0828] to-[#5d061a] p-6 text-white">
                ...
                <h3 className="mt-5 text-lg font-bold">Account Security</h3>

                <p className="mt-2 text-sm leading-6 text-white/70">
                  Keep your BanglesMart account protected with a strong
                  password.
                </p>
              </div>
            ...
            <div className="mt-5 rounded-2xl border border-[#8f0828]/10 bg-[#8f0828]/[0.03] p-4">
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="mt-1 text-xs leading-5 text-gray-500">
                    Use at least 8 characters. For better security, combine
